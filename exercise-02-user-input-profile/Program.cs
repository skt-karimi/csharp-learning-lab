namespace TEST_001_002
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!int.TryParse(Console.ReadLine(), out alder) || alder <= 0 || alder > 120) 
            {
                Console.WriteLine("Ogiltigt värde! Ange en alder mellan 1 och 120.");
            }
            ...
            //Försök igen
            Console.WriteLine($"Hej {namn}! Du är {alder} år gammal och väger {vikt} kg.");
...
// 2. Fråga efter alder och kontrollera att det är ett giltigt heltal (1–120)
